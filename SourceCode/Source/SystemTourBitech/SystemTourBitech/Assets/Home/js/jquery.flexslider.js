...
(function ($) {
    $.flexslider = function (el, options) {
        ...
        methods = {
            ...
            directionNav: {
                setup: function () {
                    var directionNavScaffold = $('<div class="paggingoverlay"><div class="main"><ul class="' + namespace + 'direction-nav"><li><a class="' + namespace + 'prev" href="#">' + vars.prevText + '</a></li><li><a class="' + namespace + 'next" href="#">' + vars.nextText + '</a></li></ul></div></div>');
            ...
            pausePlay: {
                setup: function () {
                    var pausePlayScaffold = $('<div class="paggingoverlay2"><div class="main"><div class="' + namespace + 'pauseplay"><a></a></div></div></div>');
                    if (slider.controlsContainer) {
    ...
    $.flexslider.defaults = {
        ...
        start: function () {
			...
			$(document).ready(function(){
//			$('.flex-pauseplay').clone().appendTo('.paggingoverlay');
			});
			},
        before: function () {
